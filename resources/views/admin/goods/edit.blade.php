...
<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="goods_num" value="{{$goods->goods_num}}" id="lastname" 
				   placeholder="请输入商品库存">
		</div>
	</div>
	<div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="file" class="form-control" name="goods_img" id="lastname" 
                   placeholder="请输入商品主图">
            @if($goods->goods_img)<img src="{{env('UPLOADS_URL')}}{{$goods->goods_img}}" width=50>@endif
		</div>
    </div>
    <div class="form-group">
		<label for="lastname" class="col-sm-2 control-label">商品相册</label>
		<div class="col-sm-10">
			<input type="file" class="form-control" name="goods_imgs" id="lastname" 
				   placeholder="请输入商品相册">
		</div>
    </div>
    <div class="form-group">
		...
		<div class="col-sm-10">
			<textarea type="text" class="form-control" name="goods_desc" id="lastname" 
				   placeholder="请输入品牌描述">{{$goods->goods_desc}}</textarea>
		</div>
    </div>
