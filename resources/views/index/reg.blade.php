@extends("layouts.shop")
     ...
     @csrf
      ...
      <div class="lrBox">
       ...
       <div class="lrList"><input type="password" name="reg_pwd" placeholder="输入密码（6-18位数字或字母）"/></div><b style="color:red">{{session("mi")}}</b>
       <div class="lrList"><input type="password"  name="pwd" placeholder="确认密码" /></div><b style="color:red">{{session("qmi")}}</b>
      </div><!--lrBox/-->
      <div class="lrSub">
