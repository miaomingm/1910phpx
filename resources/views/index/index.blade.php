@extends("layouts.shop")
     ...
     <div class="head-top">
      ...
      <dl>
       ...
       <dd>
        ...
        <ul>
         <li><a href="{{url('goods')}}"><strong>34</strong><p>全部商品</p></a></li>
     ...
     @foreach($slide as $v)
     <img src="{{env('UPLOADS_URL')}}{{$v->goods_img}}" width="1000px"></a>
     @endforeach 
     </div><!--sliderA/-->
     <ul class="pronav">
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{url('/goods/index/'.$v->goods_id)}}"><img src="/index/images/pro1.jpg" /></a></dt>
